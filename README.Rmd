...
`sd.u` produces a very unbiased standard deviation estimate. Makes every data look horrible. The sad but true reality. Uses a chi-distributed correction factor. 
